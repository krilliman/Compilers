...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      char dummy7[sizeof (AST::FunctionDeclNode*)];

      // if_statement
      char dummy8[sizeof (AST::IfStmtNode*)];

      // optional_arguments
      char dummy9[sizeof (AST::OptionalArgumentsNode*)];

      // procedure_statement
      char dummy10[sizeof (AST::ProcedureCallStmtNode*)];

      // procedure_declarations
      char dummy11[sizeof (AST::ProcedureDeclNode*)];

      // read_statement
      char dummy12[sizeof (AST::ReadStmtNode*)];

      // simple_statement
      // structured_statement
      // statement
      char dummy13[sizeof (AST::StmtNode*)];

      // variable_declaration
      // parameter_list
      char dummy14[sizeof (AST::VariableDeclNode*)];

      // variable_declarations
      // opt_params
      char dummy15[sizeof (AST::VariableDeclarationsNode*)];

      // input_variable
      // variable_lvalue
      char dummy16[sizeof (AST::VariableNode*)];

      // while_statement
      char dummy17[sizeof (AST::WhileStmtNode*)];

      // write_statement
      char dummy18[sizeof (AST::WriteStmtNode*)];

      // type
      // array_type
      char dummy19[sizeof (LNG::DataType)];

      // simple_type
      char dummy20[sizeof (LNG::SimpleDataType)];

      // callable_declarations_list
      char dummy21[sizeof (std::list<AST::CallableDeclNode*>)];

      // arguments_list
      char dummy22[sizeof (std::list<AST::ExprNode*>)];

      // list_statement
      char dummy23[sizeof (std::list<AST::StmtNode*>)];

      // list_variable_declaration
      // list_parameterList_declaration
      char dummy24[sizeof (std::list<AST::VariableDeclNode*>)];

      // list_identifier
      char dummy25[sizeof (std::list<std::string>)];
